...
exports.downloadFile = exports.TEMP_CACHE_DIR = void 0;
...
async function prepareFilesystem(cacheDir, siteUrl) {
  ...
  const rewrites = [
    ...
    [
      (0, path_1.join)(cacheDir, 'caches-lmdb'),
      (0, path_1.join)(exports.TEMP_CACHE_DIR, 'caches-lmdb'),
    ],
  ...
  if (
    ...
    const dataMetadataPath = (0, path_1.join)(
  ...
  (0, fs_extra_1.copySync)(
    (0, path_1.join)(cacheDir, dir),
    (0, path_1.join)(exports.TEMP_CACHE_DIR, dir),
  );
